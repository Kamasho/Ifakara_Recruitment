                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-uppercase bg-light p-2">
                                        ...
                                        <i class="mdi mdi-account-circle me-1"></i>Jobs</h5>
                                    <div class="">
                                        <div id="sidebar-menu">
                                    ...
                                    <div class="row justify-content-between mb-2">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="text-sm-end">
                                                <button type="button" class="btn btn-primary waves-effect waves-light mb-2" data-bs-toggle="modal" data-bs-target="#custom-modal">Add New Job</button>
                                            </div>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="field-2" class="form-label">Job Category</label>
                                <input type="text" class="form-control" id="field-2" placeholder="categories">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="field-5" class="form-label">Employment Type</label>
